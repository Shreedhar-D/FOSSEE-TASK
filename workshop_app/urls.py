...
urlpatterns = [
    ...
    url(r"^api/workshops/$", views.api_workshops, name="api_workshops"),
    url(
        r"^api/workshop/(?P<workshop_id>\d+)/$",
        views.api_workshop_detail,
        name="api_workshop_detail",
    ),
    url(r"^api/propose/$", views.api_propose_workshop, name="api_propose_workshop"),
]
